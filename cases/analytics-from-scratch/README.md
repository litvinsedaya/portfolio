...
- **Пайплайн данных:** чтение JSON из MinIO, парсинг (диалоги, отчёты, пользователи, школы, кейсы, оценки) и загрузка в PostgreSQL батчами. Оркестрация через Airflow DAG (по расписанию).
